 ...
 * @author Jason Heard
 */
public class RobinHoodBucketOpen {
    ...
    public RobinHoodBucketOpen(long accountNumber, String name, String address, double creditlimit, double balance) {
    ...
    */
    ...
    /**
     * sets the psl value to a new value.
     * @param psl - the psl value to set it to.
     */
    ...
    /**
     * increase the psl value.
     */

    public void increPsl()
    {
        this.psl++;
    }
    /**
     * decreases the psl value.
     */

    public void decrePsl()
    {
        this.psl--;
    }
    /**
     * gets the psl value.
     * @return the psl value.
     */
